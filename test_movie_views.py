...
class MovieViewTestCase(TestCase):
    ...
    def test_edit_usermovie_by_form(self):
        ...
        with self.client as c:
            ...
            # edit the platform and send as new data
            data = {
                "imdb_id": m.imdb_id,
                "title": m.title,
            ...
            resp = c.post(f"/movies/{self.movie_id}",
    ...
    def test_remove_movie_post_route(self):
        ...
        with self.client as c:
            resp = c.post("/movies/testID123/delete")
    ...
    def test_remove_movie_form_not_logged_in_redirect(self):
        ...
        with self.client as c:
            ...
            resp = c.get("/movies/testID123/delete")
    ...
    def test_remove_movie_form_not_logged_in_redirect_location(self):
        ...
        with self.client as c:
            ...
            resp = c.get("/movies/testID123/delete", follow_redirects=True)
            html = resp.get_data(as_text=True)
    ...
    def test_add_movie_by_json_movie_in_db(self):
        ...
        with self.client as c:
            ...
            resp = c.post("/api/movies", json=json)
    ...
    def test_edit_movie_favorite_by_json(self):
        ...
        with self.client as c:
            ...
            resp = c.patch("/api/movies/testID123", json={})

            self.assertEqual(resp.status_code, 200)

            movie = UserMovie.query.one()
